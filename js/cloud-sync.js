...
/*
    مسار مستند Firestore الخاص بالقسم
    النشط حاليًا (كل قسم له نسخة سحابية
    منفصلة تمامًا عن الآخر)
*/

function getCloudBackupDocRef() {
...
/*
    مفتاح تخزين محلي لوقت آخر مزامنة،
    خاص بالقسم النشط
*/

function getCloudSyncTimeStorageKey() {
    ...
    return `cloudLastSyncTime_${workspace}`;
